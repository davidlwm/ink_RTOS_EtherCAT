...
typedef enum {
    ...
    SENSOR_LEVEL_1,   // 浮球液位开关传感器1 (PG9)
    SENSOR_LEVEL_2,   // 浮球液位开关传感器2 (PG12)
    SENSOR_LEVEL_3,   // 浮球液位开关传感器3 (PG15)
    SENSOR_LEVEL_ANALOG, // 模拟量液位 (FRD-8061) 
...
// 执行器类型
typedef enum {
    ACTUATOR_VALVE_1,     // 电磁阀1 (24V) (IO) PE2 
    ACTUATOR_VALVE_2,     // 电磁阀2 (24V) (IO) PE3
    ACTUATOR_HEATER_1,    // 加热器1 (继电器)   PE4
    ACTUATOR_HEATER_2,    // 加热器2 (继电器)   PE5
    ACTUATOR_HEATER_3,    // 加热器3 (继电器)   PE6
    ACTUATOR_PUMP_SPEED_1, // 调速泵1 (PWM)    PF9
    ACTUATOR_PUMP_SPEED_2, // 调速泵2 (PWM)    PF10
    ACTUATOR_PUMP_DC_1,   // 直流泵1 (IO)     PF6
    ACTUATOR_PUMP_DC_2,   // 直流泵2 (IO)     PF7
    ACTUATOR_COUNT
} actuator_type_t;
```
